          ...
          <div className="card p-6 sm:p-8">
            <div className="grid gap-8 sm:grid-cols-2 items-center">
                ...
                <div className="space-y-8">
                  <div className="space-y-6">
                    <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-forground leading-tight">
                      Let's work
                ...
                <div className="justify-self-center sm:justify-self-end">
                  <Image
                    ...
                    width={400}
                    height={480}
                    className="w-56 h-64 sm:w-72 sm:h-[380px] lg:w-[380px] lg:h-[460px] object-contain"
                    priority={false}
                  />
                </div>
            </div>
